...
def iniciar_backend_red():
    """Lanza FreeRADIUS en WSL de forma silenciosa."""
    try:
        # Nota: Se usa 'sudo service freeradius start' para el modo producción/segundo plano.
        subprocess.run(["wsl", "sudo", "service", "freeradius", "start"], 
                       check=True, capture_output=True, text=True)
        print(">>> Motor FreeRADIUS iniciado.")
    except Exception as e:
        print(f">>> Aviso: WSL o FreeRADIUS no detectados o ya en ejecución. Error: {e}")
